...
- $w_1, w_2, \dots, w_d$: The **Weights**. Think of these as volume knobs on a sound board. If $w_1 = +500$, it means every additional square foot increases house price by 500 USD. If $w_2 = -2000$, it means every additional mile away from the city center decreases price by 2,000 USD.
